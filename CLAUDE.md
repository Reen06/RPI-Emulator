...
The `ros-farino` image (Pi 4B, user `robotics`, pass `farino`) is the active project image. It hosts a ROS2 Jazzy workspace for controlling a Farino FR-3 robot arm connected over direct Ethernet (Pi eth0 → 192.168.58.100/24, robot at 192.168.58.2).
